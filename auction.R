...
B7<-read.csv2("1407.csv",sep="\t",stringsAsFactors=FALSE)
B8<-read.csv2("1408.csv",sep="\t",stringsAsFactors=FALSE)
B9<-read.csv2("1409.csv",sep="\t",stringsAsFactors=FALSE)
B10<-read.csv2("1410.csv",sep="\t",stringsAsFactors=FALSE)
B11<-read.csv2("1411.csv",sep="\t",stringsAsFactors=FALSE)
B12<-read.csv2("1412.csv",sep="\t",stringsAsFactors=FALSE)
B13<-read.csv2("1501.csv",sep="\t",stringsAsFactors=FALSE)
